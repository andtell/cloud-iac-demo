...
const resourceGroup = new azure.resources.ResourceGroup(`demo-rg-${pulumi.getStack()}`, {});
...
const appContainer = new azure.storage.BlobContainer("func-app-container", {
    accountName: account.name,
    resourceGroupName: resourceGroup.name,
        ...
        appSettings: [
            {
                ...
                value: "https://ytjv6k96ai.execute-api.eu-north-1.amazonaws.com/dev/vote",
            },
